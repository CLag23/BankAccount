A simple banking application that allows users to manage a bank account, such as Deposit, withdraw, or view balance. The application consists of two main parts.
